...
class SDXLDDIMPipeline(StableDiffusionXLImg2ImgPipeline):
    ...
    def __call__(
        ...
        for t in tqdm(reversed(self.scheduler.timesteps)):
            ...
            # print(prompt_embeds)  # correct
            # print(added_cond_kwargs['time_ids'])  # correct
            # print(added_cond_kwargs['text_embeds'])
            # print(noise_pred) # wrong
            ...
            # print(t)  # correct
            # print(alpha_prod_t)  # correct
            # print(alpha_prod_t_prev)  # correct
            # print(cross_attention_kwargs)  # correct
            # print(latent_model_input)
            # print(noise_pred) # wrong
            # print(latents)
            # print(prompt_embeds)  # correct
            # print(added_cond_kwargs['time_ids'])  # correct
            # print(added_cond_kwargs['text_embeds'])  # correct
